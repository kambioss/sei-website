      ...
      <div className="sectionShell footerTop">
        <div className="footerBrand">
          ...
          <div className="footerLogoBlock">
            ...
            <span className="footerLogoNote">{english ? "Africa & international assignments" : "Afrique & missions internationales"}</span>
          </div>
        </div>
        ...
        <div className="footerContact">
          ...
          <span>{address}</span>
          <a href="mailto:contact@se-impact.com">Mail : contact@se-impact.com</a>
          <a href="tel:+21693912196">Mobile : +216 93 912 196</a>
        </div>
      </div>
