...
const ui = {
  fr: {
    ...
    galleryCaptions: ["Gestion durable des terres", "Préservation intégrée des écosystèmes", "Résilience face au dérèglement climatique"],
  ...
  en: {
    ...
    galleryCaptions: ["Sustainable land management", "Integrated ecosystem preservation", "Resilience to climate change"],
